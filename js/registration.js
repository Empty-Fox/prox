...
var email, password, confirmPassword, country, address, im_type, contact_info, company_name, url;
...
$('#button1').on('click', function () {
  ...
  if (isEmail(email) === true && isPassword(password) === true && password === confirmPassword && isLetter(country) === true && im_type && contact_info) {
    $("#tab1").addClass('ok');
    $("#tab2").addClass('active');
...
if($(window).width() <= 768) {
  $('.long_input_v').attr('placeholder', 'What CPA networks do you currently work with?');
}